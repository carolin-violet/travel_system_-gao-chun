...
INSERT INTO `comment` VALUES ('1541668194328666114', '1533770687578136577', '1534064312866316290', '挺好玩的', NULL, 0, '2022-06-28 14:21:55', '2022-06-28 14:21:55');
INSERT INTO `comment` VALUES ('1541669882569580546', '1533770687578136577', '1534064312866316290', '不错', NULL, 0, '2022-06-28 14:28:38', '2022-06-28 14:28:38');
INSERT INTO `comment` VALUES ('1541669998072324098', '1533770687578136577', '1534064312866316290', '挺好的', NULL, 0, '2022-06-28 14:29:05', '2022-06-28 14:29:05');
...
CREATE TABLE `order_form`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单id',
  `commodity_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品id',
  `tourist_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '游客id',
  `appointment_time` date NOT NULL COMMENT '预约时间',
  `phone` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '预约手机号',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '预约人姓名',
  `adult` int(0) NOT NULL COMMENT '成年人的人数',
  `child` int(0) NOT NULL COMMENT '未成年人的人数',
  `mark` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'route为线路拼单,scenic为景点门票',
  `amount` decimal(10, 2) NOT NULL COMMENT '总金额',
  `is_paid` tinyint(0) NOT NULL COMMENT '是否已支付，支付为1，未支付为0',
  `is_deleted` tinyint(0) NOT NULL COMMENT '是否删除',
  `create_time` datetime(0) NOT NULL COMMENT '订单创建时间',
  `modify_time` datetime(0) NOT NULL COMMENT '订单修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `order_form` VALUES ('1111111111111111111', '1533774645596020737', '1534064312866316290', '2022-06-30', '12345678910', 'alg', 3, 1, 'scenic', 5.30, 1, 0, '2022-06-28 10:25:44', '2022-06-28 10:25:46');
INSERT INTO `order_form` VALUES ('1542014057916194818', '1533774645596020737', '1534064312866316290', '2022-06-30', '123456789', '周杰', 4, 2, 'scenic', 8.25, 0, 0, '2022-06-29 13:16:15', '2022-06-30 13:45:38');
INSERT INTO `order_form` VALUES ('1542399288737320962', '1533779534397071361', '1534064312866316290', '2022-07-14', '12345678910', '大菠萝', 2, 1, 'route', 5.00, 0, 0, '2022-06-30 14:47:01', '2022-06-30 14:47:01');
INSERT INTO `order_form` VALUES ('2222222222222222222', '1533777962288046082', '1534064312866316290', '2022-06-30', '12345678910', 'efsdg', 2, 0, 'route', 4.00, 0, 0, '2022-06-27 19:05:07', '2022-06-30 13:46:35');
...
INSERT INTO `permission` VALUES (11, '0', 11);
...
INSERT INTO `role` VALUES (11, 'ROLE_ORDER', '管理订单');
...
-- ----------------------------
INSERT INTO `tourist_route` VALUES ('1533777962288046082', '水慢城自然一日游', '【游览景点】固城湖水慢城—高淳老街', '生态自然·心态自然', 2.00, 2.00, 0, '2022-06-06 19:48:57', '2022-06-06 19:48:57');
INSERT INTO `tourist_route` VALUES ('1533779534397071361', '慢城祈福一日游', '【游览景点】游子山真如禅寺—高淳国际慢城', '祈福自然·生态慢城，赠送长寿碗筷', 2.00, 2.00, 0, '2022-06-06 19:55:12', '2022-06-06 19:55:12');
INSERT INTO `tourist_route` VALUES ('1533780619463516162', '经典品蟹之旅', '品尝原汁原味的螃蟹和蟹黄包', '固城湖螃蟹，拥有第一个国家级长江系中华绒螯蟹原种场、第一个国家级中华绒螯蟹标准化生产综合示范区、全国第一张有机蟹认证证书和“全国第一个螃蟹生态养殖标准”。固城湖品牌自 2001 年创建，2007 年被国家质检总局认定为国家地理标志保护产品，2009 年被国家工商总局认定为中国驰名商标。民国初年，北京四大名医之一的施今墨曾比喻固城湖螃蟹为螃蟹中一甲一名夺魁天下的状元。\n\n螃蟹宴，秋尽江南蟹正肥，螃蟹上桌百味淡。赴一场螃蟹之约，开启我们的味蕾奇遇。\n\n固城湖螃蟹养殖基地，生态养殖、科技养殖。观察了解螃蟹在干净的水中栖息、爬行、觅食、脱壳；吃的是小鱼、螺蛳、玉米、小麦；养殖技术与水产研究院农业大学合作检测无残留。参观之余也可现场选购优质大闸蟹。', 2.00, 2.00, 0, '2022-06-06 19:59:31', '2022-06-06 19:59:31');
INSERT INTO `tourist_route` VALUES ('1533781160843304961', '研学线路', '与动物的深入交流', '1、通过主题活动让学生形成对自然的好奇心及探索动物世界的兴趣，并具有一定的问题意识及解决问题的能力；\n\n2、能运用观察、调查等方法探索动物世界的奥秘；能与他人合作或独立进行基本的学习研究；\n\n3、认识并理解动物与人类的和谐关系；帮助形成正确的自然观、价值观。', 2.00, 1.35, 0, '2022-06-06 20:01:40', '2022-06-27 14:43:02');
INSERT INTO `tourist_route` VALUES ('1533781557964201986', '慢城+三条垄氧吧一日游', '【游览景点】高淳国际慢城—游子山休闲旅游区三条垄', '清新高淳·氧吧慢城。空气中带点甜！ 观中国最美茶园', 2.00, 2.00, 0, '2022-06-06 20:03:14', '2022-06-06 20:03:14');

<template>
  <div class="app-container">
    ...
    <el-dialog title="线路信息" :visible.sync="dialogFormVisible">
      <el-form :model="curSite">
        <el-form-item label="站点id" :label-width="formLabelWidth" v-show="flag===0">
        ...
        <el-form-item label="站点描述" :label-width="formLabelWidth">
          <el-input
            v-model="curSite.description"
            autocomplete="off"
            type="textarea"
            :rows="4"
            placeholder="请输入内容"></el-input>
        </el-form-item>
        <el-form-item label="站点排序" :label-width="formLabelWidth">
          <el-input v-model="curSite.sort"  autocomplete="off"></el-input>
        </el-form-item>
